...
from helpers import time as etime
...
class ClockEngine:
    ...
    def __init__(self, event_engine, tzinfo=None):
        ...
        self.sleep_time = 1
        self.trading_state = True if (
            etime.is_tradetime(datetime.datetime.now()) and
            etime.is_trade_date()) else False
    ...
    def now_dt(self):
        ...
        """
        return datetime.datetime.now().replace(tzinfo=self.tzinfo)
    ...
    def _register_moment(self,
        ...
        handler = ClockMomentHandler(self, clock_type, moment, is_trading_date,
                                     makeup, call)
